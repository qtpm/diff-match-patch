...
class TestDiffMatchPatch : public QObject {
 ...
 private:
  ...
  void assertEquals(const char *strCase, const QString &s1, const QString &s2);
  void assertEquals(const char *strCase, const Diff &d1, const Diff &d2);
  void assertEquals(const char *strCase, const QList<Diff> &list1, const QList<Diff> &list2);
  void assertEquals(const char *strCase, const QList<QVariant> &list1, const QList<QVariant> &list2);
  void assertEquals(const char *strCase, const QVariant &var1, const QVariant &var2);
  void assertEquals(const char *strCase, const QMap<QChar, int> &m1, const QMap<QChar, int> &m2);
  void assertEquals(const char *strCase, const QStringList &list1, const QStringList &list2);
  void assertTrue(const char *strCase, bool value);
  void assertFalse(const char *strCase, bool value);
  void assertEmpty(const char *strCase, const QStringList &list);
